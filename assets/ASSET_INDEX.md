...
| CH01 | `assets/sprites/characters/ch01_surveyor_player_sheet.png` | integrated v1; v0.2 resize target | Current 3x4 runtime sheet uses 48x64 cells. v0.2 target is a stable 56px visual standing height with fixed foot pivot. Raw chroma-key output kept in `assets/originals/generated/ch01_surveyor_player_sprite_chromakey.png`; uncropped alpha sheet kept beside runtime sheet for review. |
