...
1. 开场车内文本，听到 `A地`、`B校` 钩子。
2. A1 展开测绘表，建立工作距离感。
3. A2/A3/A4/A5 完成第一批测绘，让童年浅层记忆和撤并通知形成第一层反差。
4. A6 旧校名牌触发地点扰动。
5. A7 纸飞机/断铅笔被对讲机打断，验证“情绪被工作理性收起”。
6. A8 档案柜回收父亲借读钩子。
7. A9 窗边裂缝把工作记录和内心裂缝叠在一起。
8. A10 回到黑板拍照复查，验证黑板 v2 是否只保留文字痕迹。
9. A11 作文本碎页进入何小满线。
10. A12 最后一张照片，最终显影和结尾卡完成闭环。
